...
var
  frmVectors: TfrmVectors;
  Vetor1 : array of Integer;
  vetor2 : array of array of Integer;
  vetor3 : array of array of array of Integer;

implementation

{$R *.dfm}

procedure TfrmVectors.FormCreate(Sender: TObject);
var i,j,k : Integer;
begin
